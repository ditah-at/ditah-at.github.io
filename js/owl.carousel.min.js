 ...
 */ ! function (a, b, c, d) {
    ...
    e.Defaults = {
        items: 3, loop: ! 1, center: ! 1, rewind: ! 1, mouseDrag: ! 0, touchDrag: ! 0, pullDrag: ! 0, freeDrag: ! 1, margin: 0, stagePadding: 0, merge: ! 1, mergeFit: ! 0, autoWidth: ! 1, startPosition: 0, rtl: ! 1, smartSpeed: 250, fluidSpeed: ! 1, dragEndSpeed: ! 1, responsive: {
        },
...
(window.Zepto || window.jQuery, window, document), function (a, b, c, d) {
    ...
    (window.Zepto || window.jQuery, window, document), function (a, b, c, d) {
        ...
        e.Defaults = {
            autoplay: ! 1, autoplayTimeout: 9e3, autoplayHoverPause: ! 1, autoplaySpeed: ! 1
        },
    ...
    (window.Zepto || window.jQuery, window, document), function (a, b, c, d) {
        ...
        e.prototype.initialize = function () {
            var b, c = this._core.settings; this._controls.$relative =(c.navContainer ? a(c.navContainer): a("<div>").addClass(c.navContainerClass).appendTo(this.$element)).addClass("disabled"), this._controls.$previous = a("<" + c.navElement + ">").addClass(c.navClass[0]).html(c.navText[0]).prependTo(this._controls.$relative).on("click", a.proxy(function (a) {
        ...
        e.prototype.destroy = function () {
            var a, b, c, d; for (a in this._handlers) this.$element.off(a, this._handlers[a]);
    ...
    (window.Zepto || window.jQuery, window, document), function (a, b, c, d) {
            ...
            this.$element = this._core.$element, this._handlers = {
                ...
                this), "prepared.owl.carousel": a.proxy(function (b) {
                    if (b.namespace) {
                        ...
                        if (! c) return; this._hashes[c] = b.content
                    }
                },
                this), "changed.owl.carousel": a.proxy(function (c) {
                    if (c.namespace && "position" === c.property.name) {
                        ...
                        if (! e || b.location.hash.slice(1) === e) return; b.location.hash = e
                    }
                },
                this)
            },
        ...
        e.prototype.destroy = function () {
            var c, d; a(b).off("hashchange.owl.navigation");
